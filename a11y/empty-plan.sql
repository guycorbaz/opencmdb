...
--
-- 🔴 **AND IT EMPTIES THE PLAN RATHER THAN TRUSTING A FRESH DATABASE** — with `DELETE`, children
-- first, not `TRUNCATE`, which a foreign key refuses. CI's `Tests` step runs against

...
counts on the story-5.8 branch: **162 (bin) + 156 (core) + 46 (xtask) = 364**, measured
with `cargo test --workspace --locked`; `master` after 5.7 merged carried **352**
(153 + 153 + 46). _(This line read "86 + 46 + 38" until
...
vocabulary), taking the workspace to **364 (162 bin + 156 core + 46 xtask)**.

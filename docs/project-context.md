...
the first firing rules, taking the workspace to **306 (135 bin + 125 core + 46 xtask)**: the join on
...
`decide` outside its own tests**. **Still no blocker** (5.6), nothing feeds the corpus harness (5.7),

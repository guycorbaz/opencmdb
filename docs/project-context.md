...
counts on `master` after 5.6 merged: **139 (bin) + 148 (core) + 46 (xtask) = 333**; on the
story-5.7 branch: **151 + 153 + 46 = 350**, measured
...
taking the workspace to **350 (151 bin + 153 core + 46 xtask)**.

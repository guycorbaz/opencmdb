...
counts on `master` are **429** (224 bin + 159 core + 46 xtask) after **5.11** merged, measured with
`cargo test --workspace` — and the `story-5.11b-order-independence` branch carries **450**
(245 + 159 + 46) at `review`, not merged (446 at implementation, **+4 from its code review**). _(This line read "after **5.9b** merged: … = 408" with a

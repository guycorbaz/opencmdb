...
counts on `master` after **5.9** merged: **181 (bin) + 156 (core) + 46 (xtask) = 383**, measured
with `cargo test --workspace`. The `story-5.9b` branch carries **402** (197 + 159 + 46) and is at
`review`, not merged. `master` after 5.8 merged carried **367** (165 + 156 + 46); after 5.7, **352**

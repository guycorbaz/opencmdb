...
counts on `master` after 5.8 merged: **165 (bin) + 156 (core) + 46 (xtask) = 367**, measured
with `cargo test --workspace`; the implementation reached 364 and the code review took it to 367.
`master` after 5.7 merged carried **352** (153 + 153 + 46). _(This line read "86 + 46 + 38" until

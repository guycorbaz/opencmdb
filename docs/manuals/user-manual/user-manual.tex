...
\begin{planned}
Editing, deleting and releasing an entry of the plan; the audit that compares the plan with the
network, and a next-free-address offer that leaves out addresses seen in use; VLANs; conflict
detection; and IPv6 are not implemented yet.
\end{planned}

...
merge. The addresses concerned keep their own \emph{Add} control, and say that they belong to
an open question.
...
An \emph{Ambiguous} line carries one control, \textbf{Resolve}, also labelled \emph{Not
yet}: what each answer records is still to be decided, and until it acts the engine keeps

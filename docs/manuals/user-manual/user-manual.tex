...
\begin{planned}
The occupancy map ships as an \emph{example} screen: the subnets, the addresses and the
conflict it draws are fabricated documentation data, labelled as such on the page. Epic~14
reads a real subnet.
\end{planned}

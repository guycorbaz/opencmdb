...
The panel beside the grid proposes the lowest address that is safe to assign: inside a
\texttt{static} range, not the network or broadcast address, not defined in the plan, \emph{never
seen on the network}, and not documented in the inventory. When several ranges cover an address ---

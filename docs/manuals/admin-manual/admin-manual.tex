...
\begin{description}[style=nextline,leftmargin=0pt]
  ...
  \item[\texttt{OPENCMDB\_DOCUMENT\_ENABLED}] Whether the documenting write route exists at
    all. It is reached from no screen today, so setting it changes nothing an operator can
    see; it is listed because this chapter otherwise names every variable, and its absence was
    found by story 6b.12's validation.
\end{description}

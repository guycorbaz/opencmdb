...
**Status: `done`** — PR #117 squash-merged 2026-08-23 as `3ad8ef6`.
...
| 2026-08-23 | ✅ **DONE** — PR #117 squash-merged as `3ad8ef6` after a green CI run **on the head commit** (checked, not assumed). Two full review rounds, four arbitrations by Guy in the first and two in the second, **48 mutation ids across §T8 and §T9**. Epic 6b: 12 of 13. |
